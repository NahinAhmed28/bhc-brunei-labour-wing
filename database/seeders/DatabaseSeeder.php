...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $permissionNames = ['manage-users', 'manage-masters', 'create-tokens', 'edit-tokens', 'edit-protected-tokens', 'manage-workers', 'manage-documents', 'view-reports', 'view-audit'];
        ...
        $roles['administrator']->permissions()->sync(Permission::whereIn('name', ['manage-masters', 'create-tokens', 'edit-tokens', 'manage-workers', 'manage-documents', 'view-reports'])->pluck('id'));
        $roles['data-entry']->permissions()->sync(Permission::whereIn('name', ['manage-workers', 'manage-documents'])->pluck('id'));
