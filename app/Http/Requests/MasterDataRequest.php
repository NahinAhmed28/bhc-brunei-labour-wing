...
class MasterDataRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return ['name' => ['required', 'max:255', 'not_regex:/[\p{Pd}\x{00AD}\x{2212}.]/u', 'unique:'.$table.',name,'.$id], 'registration_no' => 'nullable|max:100', 'license_no' => 'nullable|max:100', 'owner_name' => 'nullable|max:255', 'contact_person' => 'nullable|max:255', 'phone' => 'nullable|max:50', 'email' => 'nullable|email|max:255', 'address' => 'nullable|max:2000', 'remarks' => 'nullable|max:2000', 'is_active' => 'nullable|boolean'];
    }

    public function messages(): array
    {
        return ['name.not_regex' => 'Names may not contain hyphens or dots.'];
    }
}
